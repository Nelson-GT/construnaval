...
INSERT INTO Ventas_Salidas (numero_guia, fecha_salida, nombre_comprador, destino_ubicacion, placa_gandola, total, empresa_solicitante, rif, conductor_nombre, conductor_ci, tractor_marca, tractor_modelo, tractor_color, tractor_placa, batea_modelo, batea_color, batea_placa, origen_direccion, destino_direccion, fecha_validez_inicio, fecha_validez_fin, modo_venta) VALUES
('GU-2025-001', '2025-01-11 10:30:00', 'Siderúrgica del Este C.A.', 'Zona Industrial, Valencia', 'ABC-123', 15000.00, 'Empresa X', 'V123456789', 'Juan Pérez', 'V-98765432', 'Ford', 'F-150', 'Rojo', 'XYZ-789', 'Chevrolet', 'Blanco', 'LMN-456', 'Av. Principal, Puerto La Cruz', 'Calle 5, Barcelona', '2025-01-01', '2025-01-31', 'From Inventory'),
('GU-2025-002', '2025-01-12 14:15:00', 'Metales Reciclados S.A.', 'Av. Industrial, Maracay', 'DEF-456', 8500.00, 'Empresa Y', 'V876543210', 'Ana García', 'V-012345678', 'Toyota', 'Tacoma', 'Negro', 'UVW-012', 'Honda', 'Amarillo', 'QRS-345', 'Urbanización El Puerto, Lechería', 'Sector Industrial, Puerto La Cruz', '2025-01-02', '2025-02-01', 'Direct Sale');
