...
CREATE TABLE IF NOT EXISTS Usuarios (
    ...
    password_hash VARCHAR(255) NOT NULL, -- Aquí guardarás la contraseña encriptada (bcrypt)
    nombre_completo VARCHAR(100),
    rol ENUM('admin', 'produccion', 'ventas') NOT NULL,
    fecha_creacion TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
('admin', '$2b$10$u03J6NGFaNzZABxe9lnYT.bzM2tqhd15GaOzQ1yVBVtWHy/kTeRYm', 'Administrador General', 'admin'),
('produccion', '$2b$10$i4AAg.qzVPKvh3qtuNrPsue/51MJkVMtTuduPGh24P.3J74uhaVVK', 'Jefe Producción', 'produccion'),
('ventas', '$2b$10$TFF4WKetd0kaPNSTzUlIX.XEDiIgvjrWh8PRApnG6XBDLGZAsDl1S', 'Jefe Ventas', 'ventas');